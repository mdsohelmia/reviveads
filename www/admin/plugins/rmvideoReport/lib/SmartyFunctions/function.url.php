<?php
require_once MAX_PATH . "/www/admin/plugins/rmvideoReport/lib/Url/Url.php";
...
{
	return OX_djaxVast_Url::getCurrentScriptName() . OX_djaxVast_Url::getCurrentQueryStringWithParametersModified( $params );
}
