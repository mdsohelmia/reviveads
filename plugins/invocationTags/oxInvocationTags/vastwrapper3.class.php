 ...
 *
 */
class Plugins_InvocationTags_OxInvocationTags_vastwrapper3 extends Plugins_InvocationTags
{
    ...
    function getName()
    {
        return $this->translate("Inline Wrapper VAST 3.0");
    }
    ...
    function getNameEN()
    {
        return 'Inline  Wrapper VAST 3.0';
    }
  ...
  * users."),
	...
	{
	$buffer .= $way."/fc.php?script=rmVideo&zoneid=$zoneid&type=$vtype&format=vast3_wrapper&loc=$playerurl";
	}
	else
	{
        $buffer .= $way."/fc.php?script=rmVideo&zoneid=$zoneid&type=$vtype&format=vast3_wrapper&loc=\"+window.location.hostname+\"";
	}
	/*VAST VERSION 2.0*/
