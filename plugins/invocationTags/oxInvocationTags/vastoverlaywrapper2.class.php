 ...
 *
 */
class Plugins_InvocationTags_OxInvocationTags_vastoverlaywrapper2 extends Plugins_InvocationTags
{
    ...
    function getName()
    {
        return $this->translate("Overlay Wrapper VAST 2.0");
    }
    ...
    function getNameEN()
    {
        return 'Overlay  Wrapper VAST 2.0';
    }
  ...
  * users."),
	...
	{
	$buffer .= $way."/fc.php?script=rmVideo&zoneid=$zoneid&type=$vtype&format=vast2_wrapper&loc=$playerurl";
	}
	else
	{
        $buffer .= $way."/fc.php?script=rmVideo&zoneid=$zoneid&type=$vtype&format=vast2_wrapper&loc=\"+window.location.hostname+\"";
	}	
	/*VAST VERSION 2.0*/
