 ...
 *
 */
class Plugins_InvocationTags_OxInvocationTags_vastad3 extends Plugins_InvocationTags
{
    ...
    function getName()
    {
        return $this->translate("VAST Ad Pod");
    }
  ...
  * users."),
	...
	{
	$buffer .= $way."/fc.php?script=rmVideo&type=$vtype&zoneid=$zoneid&limit=$limit&format=vast_pod&loc=$playerurl";
	}
	else
	{
        $buffer .= $way."/fc.php?script=rmVideo&type=$vtype&zoneid=$zoneid&limit=$limit&format=vast_pod&loc=\"+window.location.hostname+\"";
	}	
	/*VAST VERSION 2.0*/
