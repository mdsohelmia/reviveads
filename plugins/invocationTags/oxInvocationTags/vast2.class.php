 ...
 *
 */
class Plugins_InvocationTags_OxInvocationTags_vast2 extends Plugins_InvocationTags
{
    ...
    function getName()
    {
        return $this->translate("Inline VAST 2.0");
    }
  ...
  * users."),
	...
	{
		$buffer .= $way."/fc.php?script=rmVideo&zoneid=$zoneid&type=$vtype&format=vast2&loc=$playerurl";
	}
	else
	{
        $buffer .= $way."/fc.php?script=rmVideo&zoneid=$zoneid&type=$vtype&format=vast2&loc=\"+window.location.hostname+\"";
	}
