 ...
 *
 */
class Plugins_InvocationTags_OxInvocationTags_vastwrapper2 extends Plugins_InvocationTags
{
    ...
    function getName()
    {
        return $this->translate("Inline Wrapper VAST 2.0");
    }
    ...
    function getNameEN()
    {
        return 'Inline  Wrapper VAST 2.0';
    }
  ...
  * users."),
	...
	{
	$buffer .= $way."/fc.php?script=rmVideo&zoneid=$zoneid&format=vast2_wrapper&loc=$playerurl";
	}
	else
	{
        $buffer .= $way."/fc.php?script=rmVideo&zoneid=$zoneid&format=vast2_wrapper&loc=\"+window.location.hostname+\"";
	}
	/*VAST VERSION 2.0*/
